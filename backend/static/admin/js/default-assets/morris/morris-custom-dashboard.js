...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["0-#0178fa-#0178fa", "0-#0178fa-#0178fa", "#0178fa"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#0178fa', '#0178fa', '#0178fa'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            pointStrokeColors: ['#0178fa', '#0178fa', '#0178fa'],
            lineWidth: 2,
            hideHover: true
        });
