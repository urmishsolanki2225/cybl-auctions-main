! function () {
    ...
    e = AmCharts.makeChart("Stack-bar", {
        ...
        graphs: [{
            id: "g1",
            valueAxis: "v1",
            lineColor: ["#4ac6ec", "#450b5a"],
            fillColors: ["#4ac6ec", "#450b5a"],
            fillAlphas: 1,
            type: "column",
            title: "Last Week ",
            valueField: "sales2",
